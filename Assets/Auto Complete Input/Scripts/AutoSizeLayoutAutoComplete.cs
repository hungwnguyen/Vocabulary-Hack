...
[ExecuteInEditMode]
public class AutoSizeLayoutAutoComplete : MonoBehaviour
{
    ...
    public void UpdateAllRect() {
        ...
        for (int i = 0; i < transform.childCount; i++) {
            if (transform.GetChild(i).gameObject.activeSelf) {
                ...
                if (rect.GetComponent<AutoSizeLayoutAutoComplete>()) {
                    rect.GetComponent<AutoSizeLayoutAutoComplete>().UpdateAllRect();
                }
