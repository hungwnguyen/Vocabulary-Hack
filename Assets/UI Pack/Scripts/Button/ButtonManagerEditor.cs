...
using UnityEngine;
using UnityEditor;
using static HungwNguyen.MUIP.ButtonManager;
                ...
                case 2:
                    ...
                    if (tempUIM != null)
                    {
                        ...
                        if (GUILayout.Button("Open UI Manager", customSkin.button))
                            EditorApplication.ExecuteMenuItem("Tools/UI Pack/Show UI Manager");

                        if (GUILayout.Button("Disable UI Manager Connection", customSkin.button))
                        {
                            if (EditorUtility.DisplayDialog("UI Pack", "Are you sure you want to disable UI Manager connection with the object? " +
                    ...
                    else if (tempUIM == null)
                    {
                        ...
                        else
                        {
                            ...
                            if (GUILayout.Button("Restore UI Manager", customSkin.button))
                            {
                                ...
                                catch { DestroyImmediate(uimb); Debug.LogError("<b>[UI Pack]</b> Cannot restore the UI Manager connection."); }
                            }
                        }
                    }
